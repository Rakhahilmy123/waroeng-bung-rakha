    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <h2 class="text-xl font-black text-slate-900 tracking-tight">Edit Kategori</h2>
            </div>
        ...
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 space-y-5">
            ...
            <div class="flex items-start gap-3 bg-white border border-slate-200 rounded-2xl p-4 shadow-sm">
                ...
                <div>
                    ...
                    <p class="text-xs text-slate-500 leading-relaxed font-medium">
                        Anda sedang mengubah data kategori: <span class="font-black text-slate-700">{{ $kategori->nama_kategori }}</span>.
                    </p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
                ...
                <div class="flex items-center gap-3 px-6 py-4 border-b border-slate-100">
                    ...
                    <div>
                        <p class="text-sm font-black text-slate-900">Update Data Kategori</p>
                        <p class="text-[10px] text-slate-400 font-medium">Perbarui nama kategori di bawah</p>
                    </div>
                </div>

                {{-- Form Body --}}
                <form method="POST" action="{{ route('kategori.update', $kategori->id) }}" class="p-6 space-y-5">
                    @csrf
                    @method('PUT')
